...
#    with tf.control_dependencies([train_value_op2]):
    ...
    sess.run(tf.global_variables_initializer())
    trainable_saver.restore(sess,"/home/zhw/rect/Realworld/real_world_tro/circular/circular2lambda0-50")
...
#                T = T+1
                ...
                if d:
                    ...
                    for k in range(T,T+20):
                        ...
                        rate.sleep()    
                    np.save("radius"+str(radius*100)+".npy",traj)                                    
                    break
            episode = episode+1
def main():
